...
eval { $v .= pmver('Catalyst::Exception','any version') };
eval { $v .= pmver('Catalyst::Plugin::Session::PerUser','any version') };
eval { $v .= pmver('Catalyst::Plugin::Session::Store::FastMmap','any version') };
...
eval { $v .= pmver('Net::Twitter','4.00001') };
